...
export default function FNavbar() {
  return (
    <Disclosure as="nav" className="bg-[#9d91db]">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 bg-[#9d91db]">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-right  sm:items-stretch sm:justify-start">
