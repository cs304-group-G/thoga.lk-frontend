      ...
      <section>
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <Link
            ...
            className="bg-blue-700 text-white hover:bg-slate-200 rounded-lg  hover:text-black p-2 "
          >
            Add Product{" "}
          </Link>
          <header>
            ...
            <button className="top-20 right-20 absolute bg-blue-500 p-3 rounded-lg text-white hover:text-black hover:bg-slate-300 ">
              Button
            </button>
          </header>
