  ...
  <div className="mx-auto max-w-screen-lg px-4 md:px-8">
    <div className="grid gap-8 md:grid-cols-2">
      ...
      <div className="space-y-4">
        <div className="relative overflow-hidden border-[2px] rounded-lg bg-gray-100">
          <img src={product.photos}  className="h-96  object-cover object-center" />
      ...
      <div className="md:py-8">
        ...
        <div className="mb-2 md:mb-3">
          <span className="mb-0.5 inline-block text-2xl text-gray-500">City : {product.title}</span>
          <h2 className="text-2xl font-bold text-gray-800 lg:text-4xl">{product.title}</h2>
        </div>
        ...
        <div className="mb-4">
          <div className="flex items-end gap-2">
            <span className="text-xl font-bold text-gray-800 md:text-2xl">Rs {product.price}</span>
