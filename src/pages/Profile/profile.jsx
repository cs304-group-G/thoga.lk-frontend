...
export default function Profile() {
  return (
    <>
    <form className='w-screen  flex flex-col justify-content-center   text-black  items-center justify-center     '>
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                ...
                <button
                  type="button"
                  className="rounded-md bg-black px-2.5 py-1.5 text-sm font-semibold  shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-400 hover:text-black "
                >
                  Change
                </button>
              </div>
              ...
              <div className="mt-2 flex justify-center rounded-lg border border-dashed border-white  px-6 py-10">
                <div className="text-center">
                  ...
                  <div className="mt-4 flex text-sm leading-6 ">
                    <label
                      htmlFor="file-upload"
                      className="relative cursor-pointer rounded-md bg-black  font-semibold  focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-white500"
                    >
